...
class TradingConfig:
    ...
    # Filters (from backtest optimization)
    MIN_RANGE_SIZE_PCT: float = float(os.getenv("MIN_RANGE_SIZE_PCT", "0.1"))
    MAX_TIME_TO_BREAK_MINS: int = int(os.getenv("MAX_TIME_TO_BREAK_MINS", "120"))
