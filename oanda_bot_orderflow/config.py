...
class TradingConfig:
    ...
    # Order flow filter
    USE_ORDER_FLOW_FILTER: bool = os.getenv("USE_ORDER_FLOW_FILTER", "true").lower() == "true"
    REQUIRE_CVD_ALIGNED: bool = os.getenv("REQUIRE_CVD_ALIGNED", "true").lower() == "true"
    MIN_VOLUME_RAMP: float = float(os.getenv("MIN_VOLUME_RAMP", "0.0"))
